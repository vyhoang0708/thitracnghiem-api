package com.thitracnghiem.api.security.jwt;

import com.thitracnghiem.common.http.filter.OptionFilter;
import com.thitracnghiem.api.security.filter.HeaderFilter;
...
public class JWTSecurityConfig {
    ...
    public SecurityWebFilterChain configure(ServerHttpSecurity http, ReactiveAuthenticationManager authenticationManager) throws Exception {
        return http
                ...
                .pathMatchers(HttpMethod.GET,"/api/category/**","/api/exam/**","/api/examDetail/**","/api/question/**","/api/test/**").permitAll()
                .pathMatchers("/api/admin/**","/api/report/**","/api/category/**","/api/question/**","/api/exam/**","/api/user/all").hasAnyAuthority("Admin","Qly")
                .pathMatchers("/api/exam/**","/api/test/**").permitAll()
