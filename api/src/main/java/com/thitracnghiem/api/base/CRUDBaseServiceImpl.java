package com.thitracnghiem.api.base;

import com.thitracnghiem.common.pagination.Pagination;
...
public abstract class CRUDBaseServiceImpl<E, R, T, ID> implements CRUDBaseService<E, R, T, ID>, BaseEntityMapping<E, R, T> {
